...
class EateryDetailViewController: UIViewController,UITableViewDelegate, UITableViewDataSource {
    ...
    @IBOutlet weak var raitButton: UIButton!
    ...
    @IBAction func unwindSegue(segue: UIStoryboardSegue){
        ...
        raitButton.setImage(UIImage(named: rating), for: .normal)
    }
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        let buttons = [raitButton, mapButton]
...
//        tableView.separatorColor = #colorLiteral(red: 0.9254902005, green: 0.2352941185, blue: 0.1019607857, alpha: 1)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "Cell", for: indexPath) as! EataryDetailTableViewCell
        ...
        case 3: cell.keyLabel.text = "Я там был?"
